    ...
    <LegalPageLayout>
      {language === 'id' ? (
        <div className="space-y-6 text-zinc-400 leading-relaxed text-justify">
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">2. Penggunaan Layanan Secara Wajar</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">3. Layanan Premium & Pembayaran</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">4. Kebijakan Pengembalian Dana (Refund)</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">5. Batasan Tanggung Jawab</h2>
          <p>Followins tidak berafiliasi, didukung oleh, atau terkait secara resmi dengan Instagram atau Meta Platforms, Inc. Kami tidak bertanggung jawab atas kerugian, kehilangan data, atau penangguhan akun Instagram Anda yang mungkin terjadi (karena aplikasi ini murni bekerja secara pasif (offline) dan tidak pernah berinteraksi dengan API Instagram Anda secara langsung).</p>

          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">6. Perubahan Syarat & Ketentuan</h2>
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed text-justify">
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">1. Description of Service</h2>
          <p>Followins is a web-based utility tool that allows users to compare Instagram followers and following lists from a data export ZIP file. The service is provided &quot;as is&quot; without any warranties.</p>

          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">2. Acceptable Use</h2>
          <ul className="list-disc pl-5 space-y-2 text-left">
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">3. Premium Services & Payments</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">4. Refund Policy</h2>
