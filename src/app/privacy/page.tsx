      ...
      {language === 'id' ? (
        <div className="space-y-6 text-zinc-400 leading-relaxed text-justify">
          ...
          <ul className="list-disc pl-5 space-y-2 text-left">
            <li>Semua pemrosesan data, perbandingan file ZIP, dan analisis dilakukan <strong>sepenuhnya di dalam browser perangkat Anda</strong>.</li>
            <li>Kami <strong>TIDAK PERNAH</strong> mengunggah file ZIP Instagram Anda, data pengikut, atau informasi pribadi Anda ke server kami.</li>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">2. Penyimpanan Lokal (Local Storage)</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">3. Layanan Pihak Ketiga</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">4. Keamanan Keuangan & Pembayaran</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">5. Anak-anak di Bawah Umur</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">6. Perubahan Kebijakan</h2>
        ...
        <div className="space-y-6 text-zinc-400 leading-relaxed text-justify">
          ...
          <ul className="list-disc pl-5 space-y-2 text-left">
            <li>All data processing, ZIP file comparison, and analysis are done <strong>entirely inside your device's browser</strong>.</li>
            <li>We <strong>NEVER</strong> upload your Instagram ZIP file, follower data, or personal information to our servers.</li>
            <li>Your files never leave your computer/device. We don't even have a server to store your data.</li>
          </ul>

          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">2. Local Storage</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">3. Third-Party Services</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">4. Financial & Payment Security</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4 text-left">5. Children Under Age</h2>
