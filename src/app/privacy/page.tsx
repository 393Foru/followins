    ...
    <LegalPageLayout>
      {language === 'id' ? (
        <div className="space-y-6 text-fluid-p text-zinc-400 leading-relaxed text-justify">
          ...
          <h2 className="text-fluid-h3 font-bold text-white mt-8 mb-4 text-left">5. Anak-anak di Bawah Umur</h2>
          ...
          <h2 className="text-fluid-h3 font-bold text-white mt-8 mb-4 text-left">6. Perubahan Kebijakan</h2>
        ...
        <div className="space-y-6 text-fluid-p text-zinc-400 leading-relaxed text-justify">
          ...
          <h2 className="text-fluid-h3 font-bold text-white mt-8 mb-4 text-left">5. Children Under Age</h2>
          ...
          <h2 className="text-fluid-h3 font-bold text-white mt-8 mb-4 text-left">6. Changes to This Privacy Policy</h2>
