...
- **Migrasi Infrastruktur ke Cloudflare Pages (Bebas Biaya & Ramah Monetisasi):** Memigrasikan *hosting* dari Vercel ke ekosistem Cloudflare Pages (`@cloudflare/next-on-pages`). Ini adalah strategi krusial untuk menghindari pemblokiran (*suspend*) dari aturan Vercel Hobby yang melarang keras aktivitas komersial (Iklan AdSense & Paywall Premium). Dengan Cloudflare Pages, biaya *bandwidth* statis (untuk *JS Bundle*) menjadi **gratis dan tak terbatas**.
